...
[![Scrapling](https://img.shields.io/badge/Scrapling-v0.4.2-orange)](https://github.com/D4Vinci/Scrapling)
...
このリポジトリは Scrapling の Claude Code MCP セットアップ手順を記録するものです。Scrapling 自体のすべての功績は、開発者の [Karim Shoair (D4Vinci)](https://github.com/D4Vinci) 氏および [コントリビューターの皆さん](https://github.com/D4Vinci/Scrapling/graphs/contributors) に帰属します。

Scrapling は [BSD 3-Clause License](https://github.com/D4Vinci/Scrapling/blob/main/LICENSE) のもとで配布されています。

## ライセンス

このドキュメントリポジトリ自体は [MIT License](./LICENSE) です。
